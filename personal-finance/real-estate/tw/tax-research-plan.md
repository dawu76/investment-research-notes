...
3. **Double Tax Protection:** The US Foreign Tax Credit **partially** offsets federal income tax but is not a complete shield. The binding constraint is the Form 1116 passive basket limit — capped at roughly (foreign income / total income) × US federal tax ≈ **$1,000–$1,600** at the actual income profile, leaving residual federal tax of similar magnitude regardless of how large the available Taiwan FTC is. NIIT (3.8%) is separately uncreditable — but at the actual income profile (MFJ, ~$160K base income), **NIIT = $0** (MAGI well below $250K MFJ threshold). California tax (~9.3% at this income level) is unrelieved by any mechanism.
...
- [ ] **Confirm Original Acquisition Date:**
    ...
    - [Department of Land Administration (地政司), MOI](https://www.land.moi.gov.tw/enhtml/index) — central authority governing Taiwan's land registration system
    - [Regulations of the Land Registration](https://www.land.moi.gov.tw/enhtml/enlawdet/29?elid=113) — MOI regulation governing registration procedures and timelines
    - [New Taipei City Land Administration Department](https://eng.land.ntpc.gov.tw/) — local office for New Taipei City property records (English interface)
    - 中文：[全國地政電子謄本系統（內政部地政司）](https://ep.land.nat.gov.tw/) — 線上申請土地及建物謄本，可查詢原始登記資料
    - 中文：[我的E政府——各類地籍謄本申請](https://www.gov.tw/News3_Content.aspx?n=2&s=381320)
    - 中文：[內政部地政司——土地登記](https://www.land.moi.gov.tw/chhtml/content/64?mcid=3490)
...
- [ ] **Confirm Actual Registration Date (登記日):**
    ...
    - [MOF — Heirs Can Now Register Inherited Property Under Collective Joint-Ownership](https://www.mof.gov.tw/eng/singlehtml/f48d641f159a4866b1d31c0916fbcc71?cntId=27ddb5dd2413423b895ffd3a3341dfb4) — confirms inheritance registration date governs holding period
    - [National Taxation Bureau of Kaohsiung — Holding Period Starts at Completion of Registration](https://www.ntbk.gov.tw/eng/singlehtml/c19e2cba4e6f4d43ba7b15040c8dbe50?cntId=e478e2564ad74cd697a9289141c2e8f5) — explicit bureau guidance on acquisition date
    - [Regulations of the Land Registration](https://www.land.moi.gov.tw/enhtml/enlawdet/29?elid=113) — legal basis for registration timing
    - 中文：[財政部——出售因繼承取得之房地，應依新制申報房地合一稅嗎？](https://www.mof.gov.tw/singlehtml/384fb3077bb349ea973e7fc6f13b6974?cntId=6d27fbf173364c3aa0d3e9f0d25e57ca) — 確認以被繼承人取得日判斷新/舊制；取得日以完成所有權移轉登記之日為準
    - 中文：[財政部稅務入口網——房屋、土地取得日之認定（問答2911）](https://www.etax.nat.gov.tw/etwmain/tax-info/understanding/tax-q-and-a/national/profit-seeking-enterprise-income-tax/house-tax-and-land-tax-consolidation/nDRr1Gm)
    - 中文：[財政部臺北國稅局——接計持有期間計算](https://www.ntbt.gov.tw/singlehtml/41ae3594197f4f69b47753ce08188516?cntId=cdeb372790044547ad6a8749ae975e4a)
    - 中文：[桃園市政府地政局——繼承登記](https://land.tycg.gov.tw/News_Content.aspx?n=3946&s=688348)
...
- [ ] **Verify 戶籍 (Household Registration) Status — affects HSTT self-use exemption (property sales tax only):**
    ...
    - **⚠ Partially unsourced:** The assertion that "having a Taiwan national ID card does not automatically mean active 戶籍" is a practical interpretation of how cancellation (廢止登記) works under the Household Registration Act — confirm directly with the local 戶政事務所 or a Taiwan CPA.

    <details><summary>Sources</summary>

    - [Department of Household Registration (戶政司), MOI](https://www.ris.gov.tw/app/en) — central authority for 戶籍 status and 戶籍謄本 applications
    - [Household Registration Act (戶籍法)](https://law.moj.gov.tw/ENG/LawClass/LawAll.aspx?pcode=D0030006) — statute governing registration, cancellation (廢止登記), and address changes
    - [NTBT — 房地合一 (HSTT) English Overview](https://www.ntbt.gov.tw/english/multiplehtml/cd61d91304fc4fb194571fea1d82ba35) — self-use exemption eligibility criteria
    - 中文：[內政部戶政司——電子戶籍謄本申辦作業](https://www.ris.gov.tw/app/portal/16) — 免費線上申請（需自然人憑證）
    - 中文：[內政部戶政司——紙本戶籍謄本申請](https://www.ris.gov.tw/app/portal/481)
    - 中文：[我的E政府——電子戶籍謄本申辦及驗證](https://www.gov.tw/News_Content_2_371532)
...
- [ ] **Determine Taiwan Tax Residency Status — affects income tax rates and withholding mechanism:**
    ...
    - **✓ Resolved:** The 20% flat rate for 財產交易所得 paid to non-residents is confirmed. The MoF tax portal's non-resident FAQ explicitly lists "財產交易所得按20%扣繳率申報納稅." Critically, property transaction income is a **self-report** category — the buyer is the nominal 扣繳義務人 but the non-resident seller or their representative must actively file.

    <details><summary>Sources</summary>

    - [MOF — 183-day resident/non-resident threshold](https://www.mof.gov.tw/eng/singlehtml/f48d641f159a4866b1d31c0916fbcc71?cntId=b8ae2181a22146fdaccfe0aaff391b39)
    ...
    - 中文：[財政部稅務入口網——非居住者扣繳率規定（問答）](https://www.etax.nat.gov.tw/etwmain/alien-tax-service/alien-tax-faq/KK9Y76o) — 明確列明財產交易所得按20%扣繳率
    - 中文：[財政部稅務入口網——非居住者如何報繳綜合所得稅](https://www.etax.nat.gov.tw/etwmain/tax-info/understanding/tax-q-and-a/national/individual-income-tax/alien-tax-question/taxation-scope/OQ0DQxJ)
    - 中文：[財政部稅務入口網——外僑所得稅與居留期間的關係](https://www.etax.nat.gov.tw/etwmain/alien-tax-service/alien-individual-income-tax/15r2N1n)
...
- [ ] **Retrieve Inheritance Tax Records:**
    ...
    - **⚠ Partially resolved:** HSTT cost basis for inherited property = 繼承時房屋評定現值及公告土地現值（CPI調整後）— the same values used in the 遺產稅 filing. The national tax authority sources them from 公告現值 records, not the filing documents themselves; confirm with Taiwan CPA which documents are accepted as cost basis proof.

    <details><summary>Sources</summary>

    - [MOF — E-tax Portal: Online Reissue of Estate Tax Certificates](https://www.mof.gov.tw/Eng/Detail/Index?nodeid=319&pid=80678) — for re-issuing 完稅證明書 and 免稅證明書
    - [MOF — Estate and Gift Tax Act](https://law-out.mof.gov.tw/EngLawContent.aspx?lan=E&id=20472&KW=Estate+Tax)
    - 中文：[財政部稅務入口網——如何申領遺產稅證明書？](https://www.etax.nat.gov.tw/etwmain/tax-info/understanding/tax-q-and-a/national/estate-tax/certification/QN716Kb) — 申請流程及所需文件
    - 中文：[財政部中區國稅局——遺產繼承流程（步驟三）](https://www.ntbca.gov.tw/singlehtml/73956170c8c84f6caf14e77161f938ab?cntId=30e3cea4885c4f89a8f33a9d3b0ad44f)
    - 中文：[財政部中區國稅局——遺產繼承流程（步驟四）](https://www.ntbca.gov.tw/singlehtml/73956170c8c84f6caf14e77161f938ab?cntId=e0e1f999b51b4d67be1a5e7be204aa5d) — 完稅/免稅證明書為辦理產權移轉登記先決條件
...
- [ ] **Retrieve 2022 Government-Assessed Values:**
    ...
    - **⚠ Resolved (房屋評定現值):** 房屋現值 is confidential tax data (稅捐稽徵法§33) — must be obtained by requesting a **房屋稅籍證明書** from the 稅捐稽徵處 (online, by mail, or in person). No public self-service lookup exists.

    <details><summary>Sources</summary>

    - [MOI — 公告現值 National Online Lookup](https://www.land.moi.gov.tw/chhtml/landvalue/42) — historical assessed land values by parcel and year
    - [Land Price Inquiry Network (地政資訊網路服務e點通)](https://pqt.ttt.nat.gov.tw/landprice.jsp) — 公告現值 and 公告地價 by district, section, parcel
    - [New Taipei City Land Administration Bureau — Land Price Section](https://www.land.ntpc.gov.tw/cl.aspx?n=20)
    - 中文：[新北市政府稅捐稽徵處——如何查詢房屋現值？](https://www.tax.ntpc.gov.tw/cp-2158-1225-7f578-1.html) — 房屋稅籍證明書申請方式
    - 中文：[新北市政府稅捐稽徵處——線上申辦服務入口](https://www.tax.ntpc.gov.tw/np-7-1.html)
    - 中文：[公告地價歷年調整表（內政部地政司）](https://www.land.moi.gov.tw/chhtml/content/65?mcid=2942&qitem=1)
...
- [ ] **Obtain 2022 Fair Market Value (FMV):**
    ...
    - **⚠ Note on §1014(f) and Form 706:** §1014(f) basis-consistency rules do not apply here — the decedent was a US citizen whose estate was well below the 2022 exclusion threshold (~$12,060,000), so no Form 706 was required. The stepped-up basis is FMV at date of death, documented by whatever evidence is available.
    - Taiwan's **實價登錄** database is the primary source for May 2022 FMV comparables (see "Establishing FMV" section below).

    <details><summary>Sources</summary>

    - [IRS Publication 551 — Basis of Assets](https://www.irs.gov/publications/p551) — authoritative source on stepped-up basis for inherited property
    ...
    - [IRS Publication 561 — Determining the Value of Donated Property](https://www.irs.gov/publications/p561) — qualified appraisal standards and FMV methodology
...
- [IRS Publication 561 — Qualified Appraisal Standards & FMV Methodology](https://www.irs.gov/publications/p561)
...
- [ ] **Gather Deductible Expense Records:**
    ...
    - **⚠ CPI adjustment required:** The 繼承時房屋評定現值及公告土地現值 must be **adjusted by the CPI as of the month of sale** before use as the HSTT cost basis. This is a documented common error — omitting it under-claims cost basis and overpays tax. Ensure your Taiwan CPA applies this adjustment.

    <details><summary>Sources</summary>

    - [NTBT — 房地合一 (HSTT) English Overview](https://www.ntbt.gov.tw/english/multiplehtml/cd61d91304fc4fb194571fea1d82ba35) — eligible deduction categories
    - [NTBT — Filing 房地合一所得稅 (HSTT Return)](https://www.ntbt.gov.tw/english/htmlList/88c7365da64c421c8455d20116172462) — documentation required for each deduction
    - [Taxation Administration, MOF — LVIT](https://www.dot.gov.tw/Eng/singlehtml/en_143) — Old System LVIT reference
    - 中文：[財政部——繼承取得房地HSTT成本計算規則（CPI調整）](https://www.mof.gov.tw/singlehtml/384fb3077bb349ea973e7fc6f13b6974?cntId=4f67457f68ee4c5ea98bad28127d4584) — 核心法源：確認CPI調整為必要步驟
    - 中文：[財政部稅務入口網——房地合一課徵個人所得稅相關問題](https://www.etax.nat.gov.tw/etwmain/web/ETW118W/CON/904/5887006684254281366) — 可減除費用認定標準
    - 中文：[財政部稅務入口網——申報房地合一稅應如何申報及檢附文件](https://www.etax.nat.gov.tw/etwmain/alien-tax-service/alien-tax-faq/05KVgzL)
...
- [ ] **Old System — Building Gain Income Tax Modeling:**
    ...
    - As a **Taiwan tax non-resident** (<183 days — confirmed scenario): the building gain is instead subject to a confirmed **flat 20% rate** (財產交易所得按20%扣繳率申報納稅). This is the scenario to model and is more favorable than progressive rates.
...
**Note on the Phase 2 building gain bullet above:** That bullet describes progressive Taiwan resident rates (up to ~40%). For a confirmed non-resident (<183 days/year), the building gain is instead subject to a **confirmed flat rate of 20%** (財產交易所得按20%扣繳率申報納稅). This non-resident treatment is actually *more favorable* than resident progressive rates and is a key input to the comparison below.
...
| **Filing deadline** | 30 days from transfer registration | Building: handled at time of transaction (buyer withholds from 尾款, or representative self-reports); LVIT: filed within 30 days of contract signing, paid before title transfer |

<details><summary>Sources for table above</summary>

- [HSTT rate schedule & 30-day deadline (NTBT English)](https://www.ntbt.gov.tw/english/multiplehtml/cd61d91304fc4fb194571fea1d82ba35)
- [Land Tax Act — LVIT rate tiers](https://law.moj.gov.tw/ENG/LawClass/LawAll.aspx?pcode=G0340096)
- [LVIT rate tiers 貳 (財政部稅務入口網)](https://www.etax.nat.gov.tw/etwmain/tax-info/understanding/tax-saving-manual/local/land-value-increment-tax/noaGA0q)
- [Old System building gain — annual income return (財政部)](https://www.mof.gov.tw/singlehtml/384fb3077bb349ea973e7fc6f13b6974?cntId=684c43657d2f44779b94ee3fe0838529)
- [LVIT filed at time of sale — 我的E政府](https://www.gov.tw/News_Content_2_378930)
- [Building/land split uses time-of-sale assessed values Q1142](https://www.etax.nat.gov.tw/etwmain/tax-info/understanding/tax-q-and-a/national/individual-income-tax/taxation-scope/which-income/r8q3EDv)
...
*Assumptions: assessed values at inheritance = NT$4.2M (NT$3.5M land + NT$700K building); CPI-adjusted basis = NT$4.7M; deductible expenses = NT$350K (seller-side agent commission ~1.5% + stamp duty + 代書 + notary; buyer's commission is paid by the buyer); non-resident flat rate confirmed 20% for building gain.*
...
| Rate (non-resident flat, confirmed 20%) | 20% |
...
4. **Non-resident status is an Old System advantage.** Building gain for a non-resident is taxed at 20% flat rather than the progressive resident rate (up to ~40%). At the same building gain amount, a Taiwan resident would pay roughly double the building income tax. This makes the Old System comparatively more attractive for US-based owners than it would be for Taiwan residents. (Sources: [財政部 — 非居住者扣繳率](https://www.etax.nat.gov.tw/etwmain/alien-tax-service/alien-individual-income-tax/vV8Z3o9); [財政部稅務入口網 — 非居住者扣繳率規定](https://www.etax.nat.gov.tw/etwmain/alien-tax-service/alien-tax-faq/KK9Y76o) — explicitly lists 財產交易所得按20%扣繳率申報納稅)
...
7. **US tax is largely symmetric across both Taiwan regimes.** Because the US stepped-up basis resets to FMV at May 2022 (not the original purchase date), US capital gain = price appreciation since 2022 only. The Taiwan regime choice does not change the US gain calculation; it only affects the Foreign Tax Credit available to offset US tax. Higher Taiwan tax → larger FTC → lower net US tax (up to the FTC limitation). NIIT (3.8%) is not offset by FTC — but at the actual income profile (~$160K base income, MFJ), NIIT = $0: MAGI stays well below the $250K MFJ threshold for all positive-gain scenarios shown. NIIT becomes relevant only if non-property MAGI grows to ~$236K+. ([IRS Pub 551 — Inherited Property stepped-up basis](https://www.irs.gov/publications/p551); [IRS — About Form 1116, Foreign Tax Credit](https://www.irs.gov/forms-pubs/about-form-1116))
...
- **In either case:** engage a Taiwan CPA to (a) apply the CPI adjustment to cost basis, (b) calculate actual 公告地價 at original purchase year for LVIT estimation, and (c) coordinate Old System payment logistics (LVIT timing at 完稅, building income tax withholding from 尾款 or representative self-report)
...
- [ ] **Confirm Stepped-Up Basis Eligibility (IRC §1014):**
    ...
    - [IRS — Estate Tax FAQ (Form 706 filing threshold)](https://www.irs.gov/businesses/small-businesses-self-employed/frequently-asked-questions-on-estate-taxes)
    - [IRS Publication 551 — Basis of Assets](https://www.irs.gov/publications/p551) — stepped-up basis for inherited property
    - [IRS FAQ — Gifts & Inheritances](https://www.irs.gov/faqs/interest-dividends-other-types-of-income/gifts-inheritances/gifts-inheritances)
    - [IRS Topic 703 — Basis of Assets](https://www.irs.gov/taxtopics/tc703)
...
- [ ] **Calculate US Capital Gain:**
    ...
    - [IRS Publication 544 — Sales and Other Dispositions of Assets](https://www.irs.gov/publications/p544) — gain computation including foreign real estate
    - [IRS — About Form 8949](https://www.irs.gov/forms-pubs/about-form-8949) — "INHERITED" in column (b) gives automatic long-term treatment
    - [IRS Instructions for Schedule D](https://www.irs.gov/instructions/i1040sd)
    - [IRS — Foreign Currency and Currency Exchange Rates](https://www.irs.gov/individuals/international-taxpayers/foreign-currency-and-currency-exchange-rates) — spot rate on transaction date
...
- [ ] **Apply Long-Term Capital Gains Rate:**
    ...
    - [IRS Topic no. 409 — Capital Gains and Losses](https://www.irs.gov/taxtopics/tc409) — inherited property is automatically long-term
    - [IRS Instructions for Schedule D](https://www.irs.gov/instructions/i1040sd) — Part II (long-term) for inherited property, IRC §1223(11)
...
- [ ] **Check Net Investment Income Tax (NIIT):**
    ...
    - [IRS Topic no. 559 — Net Investment Income Tax](https://www.irs.gov/taxtopics/tc559) — NIIT rate, MAGI thresholds, what counts as NII
    - [IRS — Q&A on the Net Investment Income Tax](https://www.irs.gov/newsroom/questions-and-answers-on-the-net-investment-income-tax) — confirms investment real estate gain is subject to NIIT; FTC cannot reduce NIIT
    - [IRS — About Form 8960](https://www.irs.gov/forms-pubs/about-form-8960)
...
- [ ] **Apply Foreign Tax Credit (Form 1116):**
    ...
    - [IRS Publication 514 — Foreign Tax Credit for Individuals](https://www.irs.gov/publications/p514) — basket categories, limitation computation, rate-differential adjustment
    - [IRS Instructions for Form 1116](https://www.irs.gov/instructions/i1116) — rate-differential adjustment: 0.4054 (15% group) or 0.5405 (20% group)
    - [IRS Topic no. 856 — Foreign Tax Credit](https://www.irs.gov/taxtopics/tc856)
    - [IRS — Foreign Tax Credit (eligibility overview)](https://www.irs.gov/individuals/international-taxpayers/foreign-tax-credit)
...
- [ ] **Identify Informational Filing Requirements:**
    ...
    - [IRS — About Form 3520](https://www.irs.gov/forms-pubs/about-form-3520) — required for bequests from foreign estates >$100K (not applicable here)
    - [FinCEN — FBAR (FinCEN Form 114)](https://www.fincen.gov/report-foreign-bank-and-financial-accounts) — $10,000 aggregate threshold, April 15 due date
    - [IRS — FBAR](https://www.irs.gov/businesses/small-businesses-self-employed/report-of-foreign-bank-and-financial-accounts-fbar) — penalty framework and BSA e-filing
    - [IRS — About Form 8938](https://www.irs.gov/forms-pubs/about-form-8938) — FATCA thresholds and what counts as "specified foreign financial assets"
    - [IRS — Basic Q&A on Form 8938](https://www.irs.gov/businesses/corporations/basic-questions-and-answers-on-form-8938) — confirms foreign real property held directly is NOT reportable
...
- [ ] **Check State Income Tax:**
    ...
    - **⚠ California foreign tax credit:** California's credits are limited to taxes paid to other US states — no credit for Taiwan taxes. Confirm with FTB or a California CPA.
    - For all other states: consult your state tax authority's website or a state-tax-experienced CPA.

    <details><summary>California sources</summary>

    - [California FTB — Capital Gains and Losses](https://www.ftb.ca.gov/file/personal/income-types/capital-gains-and-losses.html) — all capital gains taxed as ordinary income; no preferential rate
    - [California FTB — 2025 Tax Rate Schedules](https://www.ftb.ca.gov/forms/2025/2025-540-tax-rate-schedules.pdf) — rates 1%–13.3%
...
*At 15% federal long-term rate: ~$1,882 federal income tax on the gain. Taiwan HSTT paid ≈ $42K USD — but the usable FTC is capped by the Form 1116 passive basket limit, not the absolute size of Taiwan tax. At the actual income profile (~$172K total income, $16.5K foreign passive income including $4K ETF dividends): FTC limit ≈ ($16.5K / $172K) × $10,500 ≈ **$1,005**; property-allocated portion ≈ ($12.5K / $16.5K) × $1,005 ≈ **$761** → net federal income tax ≈ **$1,121** (not zero; excess FTC carries forward 10 years). NIIT: **$0** — MAGI ~$172K is well below the $250K MFJ threshold. California at **9.3%** (MFJ marginal rate at this income level): ~**$1,167** with no relief.*
...
- [ ] **Taiwan Filing Deadlines:**
    ...
    - **Old System — LVIT:** Declare with the local tax bureau (新北市政府稅捐稽徵處 for this property) within **30 days** of contract signing (土地稅法第49條). LVIT must be **paid in full before the 地政事務所 accepts the title transfer registration** — it is a blocking prerequisite for closing.
    - **Old System — Building income tax:** There is **no annual income tax return filing** for non-residents. Property transaction income (財產交易所得) is a self-report category handled at the time of transaction via one of two routes: (Route A) buyer withholds 20% of the building gain from the final payment (尾款) and remits to the National Taxation Bureau within 10 days; or (Route B) seller's 稅務代理人 files and pays before the seller departs Taiwan or within the statutory window (所得稅法§73). The 登記日 (title registration date) determines which tax year the income falls into, but no May-June annual return is required for non-residents.

- [ ] **Designate a Taiwan-based authorized representative (稅務代理人) before closing:**
    - As a non-resident, you will almost certainly not be physically present in Taiwan during the filing windows after closing. Deadlines run regardless of your location.
    - For **New System (HSTT)**: the 代理人 receives the buyer's withholding certificate, files the HSTT return within 30 days of transfer registration, and remits any balance due or files for a refund.
    - For **Old System — Building income tax**: if using Route B (representative self-report rather than buyer withholding), the 稅務代理人 must file and pay 20% of the building gain before the seller departs Taiwan or within the statutory window under 所得稅法§73.
    - For **Old System — LVIT**: the handling 代書 coordinates the LVIT declaration and payment as part of the 完稅 stage; this is procedurally standard and does not require separate engagement, but confirm the 代書 is handling it.
    - Confirm the 稅務代理人 designation in writing before the sale closes. Without a local representative, hard filing deadlines create a practical compliance risk that cannot be resolved remotely after the fact.

- [ ] **Non-Resident Withholding at Closing — triggered by tax residency (183-day rule), not 戶籍:**
    - **New System (HSTT):** The buyer is required to withhold a portion of the purchase price and remit it to the tax authority on your behalf. The withheld amount is credited against your final HSTT liability; if withholding exceeds actual tax, file for a refund.
    - **Old System — Building income tax (Route A):** The buyer (as 扣繳義務人) withholds 20% of the *building-gain portion only* from the final payment (尾款, typically ~70% of the total price), and remits to the National Taxation Bureau within 10 days. This is not a withholding of the full purchase price — only the income gain on the building allocation.
    - **Old System — Building income tax (Route B):** If the parties agree to Route B instead, the seller's 稅務代理人 self-reports and pays directly. In this case no buyer withholding occurs at closing.
    - Confirm which route (A or B) the buyer and 代書 will use before closing, and ensure the 稅務代理人 is briefed accordingly.

- [ ] **Payment from Sale Proceeds — Old System:**
    - **LVIT** is paid from early installments or directly from the 履保 (履約保證) escrow account at the 完稅 stage — before the final 尾款 is released. The 代書 can deduct LVIT from the buyer's deposited installment in the escrow account. The standard payment ladder (10% at signing / 10% at 用印 / 10% at 完稅 / 70% at 交屋) means the seller has received ~20% (~NT$2.9M on a NT$14.5M sale) before LVIT falls due, more than sufficient to cover ~NT$410K–570K in estimated LVIT.
    - **Building income tax** is explicitly **excluded** from 履保 disbursements (履保accounts do not cover income-type taxes, whether 房地合一稅 or 財產交易所得稅). Under Route A it is withheld from the 尾款 before release to the seller; under Route B the seller's representative pays after the full proceeds have been received.
